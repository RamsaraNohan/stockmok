...
| `TABLE-018` | Columns **Business · Handle · Relationship · State · Action** + the *"N order placed"* sub-line (`DV-12`) + tab counts `All / Connected / Waiting / Past`. *Mapped Items* and *Open Connected POs* deleted. |
