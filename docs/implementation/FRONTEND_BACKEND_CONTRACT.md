...
| Connected businesses | **Business · Handle · Relationship · State · Action**, the *"N order placed"* sub-line, and tab counts. Per DB-CR-040, the count is lifetime successfully submitted connected orders; later cancellation does not decrement it. No *Mapped Items*, no *Open Connected POs*. |
