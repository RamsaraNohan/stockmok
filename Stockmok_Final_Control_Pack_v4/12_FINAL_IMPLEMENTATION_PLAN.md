# Stockmok — Final Implementation Plan v3.0
...
|---|---|
| **STAGE-ID** | S6 |
| **OBJECTIVE** | The correctness heart of Stockmok: an immutable ledger with atomic, idempotent, exactly-reconciling balances. |
| **DEPENDENCIES** | S5 |
...
|---|---|
| **STAGE-ID** | S12 |
| **OBJECTIVE** | Two Stockmok organizations can find each other by handle and form a directional, auditable relationship. |
