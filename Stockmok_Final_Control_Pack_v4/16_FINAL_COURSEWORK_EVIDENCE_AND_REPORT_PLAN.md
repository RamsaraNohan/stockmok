# Stockmok — Final Coursework Evidence & Report Plan v3.0
...
- Inventory value uses the product's current purchase cost (1,250.00), not the PO price. Stated as a deliberate design decision: Stockmok reports replacement-cost value, not weighted-average cost. Weighted-average costing is Release D.
...
| 9 | Private supplier → PO → mark Ordered | procurement | "no fake in-platform acceptance for a supplier who isn't a Stockmok user" |
