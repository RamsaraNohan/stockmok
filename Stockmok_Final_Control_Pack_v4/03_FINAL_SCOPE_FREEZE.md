# Stockmok — Final Scope Freeze v3.0
...
> **Stockmok Coursework Release = a complete, tested, deployed Release A, plus the largest Release B-Lite subset that passes every security and data-integrity test before code freeze on 22 August 2026.**
>
