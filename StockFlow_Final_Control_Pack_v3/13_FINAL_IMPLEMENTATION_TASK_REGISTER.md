# StockFlow — Final Implementation Task Register v3.0
...
| SF-0005 | Create `packages/shared` and wire path aliases | P0 | X | CC | MED | SF-0002 | NFR-011 | — | `packages/shared/**`, tsconfig paths | app imports `@stockflow/shared` and typechecks | S |
...
| ID | Title | PRI | REL | TOOL | EFF | Deps | Req | Tests | Expected files | Definition of done | Size |
|---|---|---|---|---|---|---|---|---|---|---|---|
| SF-0400 | Draft the report to the `16` §2 structure | P0 | X | ST | HIGH | SF-0395 | CW-19/20 | — | `report/StockFlow_Report.docx` | student's own words throughout | XL |
...
| SF-0410 | Package source code for DLE submission | P0 | X | ST | MED | SF-0396 | CW-12, ADM-006 | — | `StockFlow_Source.zip` | excludes `node_modules`, includes docs and tests | S |
